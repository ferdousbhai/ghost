...
export const PRINCIPAL_TASK_POLICY = [
  ...
  "Delegation is optional and does not replace your memory, Documents, planning and todo, continuity, schedules, communications, browser, computer, CLI, recap, queue, titles, or other owner-agent responsibilities.",
].join("\n");
