...
/**
 * The whole Claude/cloud environment family. Pi and every ordinary daemon child
 * lose it wholesale, so a variable a future release adds is gone before it is
 * ever enumerated above.
 */
