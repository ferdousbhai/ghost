...
const BUILTINS: readonly BuiltinSpec[] = [
  ...
  { name: "fork", description: "Fork the session", availability: "unsupported", reason: "Conversation forking is not available in Ghost." },
  { name: "clone", description: "Clone the session", availability: "unsupported", reason: "Conversation forking is not available in Ghost." },
