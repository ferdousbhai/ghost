...
Ghost never searches for or mirrors items belonging to pi or OMP, so installing
all three against the same desktop keyring does not join their credential
lifecycle. OAuth accounts should sign in afresh; copying a rotating refresh
